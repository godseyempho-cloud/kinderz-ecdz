    ...
    <div className="max-w-2xl mx-auto space-y-6 p-8">
      ...
      <div className="bg-white border rounded-2xl p-8 shadow-sm">
        ...
        <p className="text-slate-500 mb-8">
          Set up credentials for a new ECD Center Supervisor or Provincial Auditor manually.
        </p>
        
        {/* Satisfying RegisterFormProps with default/null values for Admin-side manual creation */}
        <RegisterForm 
          email="" 
          token="" 
          role="SUPERVISOR" 
